...
#ifdef CONFIG_DEBUG_UART_KUNLUN
...
static int kunlun_serial_of_to_plat(struct udevice *dev)
{
...
static const struct udevice_id kunlun_serial_ids[] = {
	{ .compatible = "semidrive,kunlun-uart", },
...
U_BOOT_DRIVER(kunlun_serial) = {
	.name	= "kunlun_serial",
	.id	= UCLASS_SERIAL,
#if CONFIG_IS_ENABLED(OF_CONTROL) && !CONFIG_IS_ENABLED(OF_PLATDATA)
	.of_match = kunlun_serial_ids,
	.of_to_plat = kunlun_serial_of_to_plat,
